...
set DEFAULT_JVM_OPTS="--module-path" "%APP_HOME%\lib" "--module" "org.notepad.notepad/org.notepad.notepad.Notepad"
...
@rem Execute Notepad
"%JAVA_EXE%" %JAVA_OPTS% %NOTEPAD_OPTS% %DEFAULT_JVM_OPTS% %*
...
if not ""=="%NOTEPAD_EXIT_CONSOLE%" exit %EXIT_CODE%
exit /b %EXIT_CODE%
